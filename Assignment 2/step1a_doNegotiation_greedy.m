%% step1a_doNegotiation_greedy.m description
% This is the greedy algorithm that is used in the default code. 
    ...
    for j = 2:nCandidates+1
        ...
        if flightsData(acNr1,2) == 1 && flightsData(acNr2,2) == 1             
            ...
            if potentialFuelSavings > 0     
                ...
                % formation size of both flights. In essence,
                % fuelSavingsOffer is the portion of potentialFuelSavings
                % that acNr2 offers to acNr1.
                ...
                % formation size of both flights. 
