    ...
    methods
        function obj = Plane(plane_handle, lattice_size, boids)
            ...
            for i=1:length(boids)
                ...
                x = [boids(i).position(1)-2.5 boids(i).position(1)+2.5 boids(i).position(1)-2.5 boids(i).position(1)-2.5];  % What does this line??
                y = [boids(i).position(2)-1.5 boids(i).position(2) boids(i).position(2)+1.5 boids(i).position(2)+1.5];  % What does this line??
