classdef Boid % Agent
    ...
    methods
        ...
        function obj = apply_force(obj, sep_force, coh_force,  ali_force)
            ...
            %  obj.acceleration = obj.acceleration + coh_force + sep_force;
               obj.acceleration = obj.acceleration+ali_force;
            %  obj.acceleration = obj.acceleration+sep_force;
        end
        ...
        function [steer] = seperate(obj, boids)
            ...
            d = d(1:length(boids));
            for i=1:1:length(boids)
                if d(i) > 0 && d(i) <  desired_separation %&& d(i) < (desired_separation + 20)
